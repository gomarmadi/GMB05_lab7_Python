...
class Form2(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QtGui.QIcon('images/logo.png'))
        self.label_img.setPixmap(QPixmap('images/multik.png'))
...
class Form3(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QtGui.QIcon('images/logo.png'))
        self.label_img.setPixmap(QPixmap('images/gamecomputer.png'))
        self.label_img.setScaledContents(True)
...
class Form4(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QtGui.QIcon('images/logo.png'))
        self.label_img.setPixmap(QPixmap('images/programming.png'))
        self.label_img.setScaledContents(True)
